    ...
    <div className="dashboard-layout">
      ...
      <aside className={`dashboard-sidebar ${isSidebarOpen ? "open" : ""}`}>
        ...
        <nav className="sidebar-nav">
          ...
          <p className="sidebar-section-label">Healthcare</p>

          <button className="nav-item nav-btn" onClick={() => { setSidebarOpen(false); handleMeraDocEntry(); }}>
            {Icons.medical}
            Doctor Consultancy
          </button>

          <Link href="/consultancy/profile?tab=appointments" className="nav-item" onClick={() => setSidebarOpen(false)}>
          ...
          <Link href="/consultancy/profile?tab=prescriptions" className="nav-item" onClick={() => setSidebarOpen(false)}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <Link href="/consultancy/profile?tab=labtests" className="nav-item" onClick={() => setSidebarOpen(false)}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <Link href="/consultancy/profile?tab=family" className="nav-item" onClick={() => setSidebarOpen(false)}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
